...
# -----------------------------------------------------------------------------
# Proyecto : slep_idps — Motor de comparacion de Indicadores de Desarrollo
#            Personal y Social (IDPS) de establecimientos (SLEP Costa Central)
# Autor    : Tomas
...
ruta_guarda <- file.path(ruta_raiz, "10_utils", "10_locale.R")
