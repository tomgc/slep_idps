...
- **Fecha:** 2026-06-11 19:54:53
- **Totales:** 13 carpetas, 61 archivos
...
│   │   ├── REX N° 1459 (Deja sin ef REX 695, 701, 241 y 333).pdf  (3.16M)
│   │   └── Taller+Conozcamos+los+IDPS+para+docentes+y+estudiantes.pdf  (1.68M)
│   ├── .DS_Store  (6K)
│   ├── .gitkeep  (0)
│   ├── idps2m_niveles_final.xlsx  (3.44M)
...
│   ├── idps4b_niveles_final.xlsx  (7.59M)
