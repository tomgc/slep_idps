...
cfg$decisiones <- list(
  ...
  list(id='D8', titulo='Cobertura histórica: la máxima que permite la fuente',
       cuerpo='<p>El parquet cubre la serie <strong>2014–2025</strong>, pero la cobertura real no es pareja: varía por <strong>familia</strong> y por <strong>grado</strong>. Por familia — indicador: 2014–2025; dimensión: 2018 (histórico) + 2022–2025 (moderno); niveles: 2023–2025 (2024 para 6° y 8° básico). Por grado — 2° medio y 4° básico: 2014–2018 y 2022–2025 (9 años cada uno); 6° y 8° básico: aplicación <strong>intermitente</strong>, no anual (años sueltos, no un rango continuo). El motor expone solo 4° básico y 2° medio; los 4 grados se conservan en el parquet.</p>',
       por_que='<strong>Por qué.</strong> Los huecos de cobertura son <strong>ausencia de aplicación del instrumento en origen</strong>, no deuda de ingesta ni datos pendientes de traer: el script <span class="inl">34</span> ya lee todo lo que la Agencia publicó y no requiere extensión para "traer más histórico". En 2019, donde correspondía aplicar la medición en 4° básico y 2° medio como cada año, la Agencia informa (fuente pública en su sitio) que los incidentes tras el 18 de octubre alteraron la aplicación de 4° básico en varios establecimientos y que 2° medio no pudo realizarse. En 2020–2021 el hueco es común a todos los grados por la pandemia. Respaldo completo, con la referencia pública íntegra, en la decisión <span class="inl">20260625_decision_cobertura_historico_idps.md</span>.')
)
...
cfg$garantias <- list(
  ...
  list(icon='calendar-x', titulo='No inventamos años sin medición', d='En 2020 y 2021 no hubo evaluación por la pandemia. En 2019, 4° básico tuvo su aplicación alterada y 2° medio no se aplicó. Esos vacíos se muestran como vacíos, nunca como una línea continua.'),
...
cfg$notas <- list(
  ...
  list(icon='calendar-x', tx='<strong>Hay años en gris.</strong> No es un error: en 2020–2021 fue la pandemia; en 2019, 4° básico se alteró y 2° medio no se aplicó. Se marca a propósito.'),
...
cfg$faq <- list(
  ...
  list(q='¿Qué significa que un año aparezca en gris?', a='Que no hubo evaluación de ese indicador ese año. En 2020 y 2021 fue por la pandemia, y afectó por igual a 4° básico y a 2° medio. En 2019 el motivo fue distinto para cada grado: la Agencia informa que 4° básico tuvo su aplicación alterada en varios establecimientos, mientras que 2° medio directamente no se aplicó. No es un dato faltante por error: es que no se midió.', abierta=FALSE),
